...
from models.modelling_llama3 import (
...
from models.modelling_qwen2 import Qwen2ForCausalLM, Qwen2Attention
from models.modelling_phi3 import Phi3ForCausalLM, Phi3Attention
from models.modelling_phi import PhiForCausalLM, PhiAttention
from models.modelling_olmo2 import Olmo2ForCausalLM, Olmo2Attention
from models.phi_modelling_aug_collect import *
from models.ph3_modelling_aug_collect import *
from models.mistral_modelling_aug_collect import *
from models.qwen3_modelling_aug_collect import *
from models.qwen2_modelling_aug_collect import *
...
from models.modelling_gemma3 import Gemma3ForCausalLM, Gemma3Attention
from models.gemma3_modelling_aug_collect import *
from models.llama3_modelling_aug_collect import *
from models.mistral_modelling_aug_predict import *
from models.llama3_modelling_aug_predict import llama3_atten_aug_forward_predict, llama3_flash_atten_aug_forward_predict
...
def main(args):
    ...
    if args.kv_collection:
        ...
        Llama3FlashAttention.forward = llama3_flash_atten_aug_forward_collect
        MistralAttention.forward = mistral_atten_aug_forward_collect
        Qwen3Attention.forward = qwen3_atten_aug_forward_collect
        Qwen2Attention.forward = qwen2_atten_aug_forward_collect
        Gemma3Attention.forward = gemma3_atten_aug_forward_collect
        Phi3Attention.forward = ph3_atten_aug_forward_collect
        ...
        if args.predict_keys or args.predict_values:
            ...
            MistralAttention.forward = mistral_atten_aug_forward_predict
