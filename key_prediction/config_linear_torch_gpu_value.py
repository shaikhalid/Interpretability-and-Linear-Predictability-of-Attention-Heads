...
CONFIG = {
    ...
    'file_path': 'kv_pickles/v_cache_data_gsm8k_f3b.pkl',  # Or your k_cache data file
    ...
    'matrix_type': 'v_matrix',  # Change to 'k_matrix' if using k_cache data
    'include_prefill': True, # NEW: Set to False to exclude prefill tokens from training/evaluation
    'exclude_N_decode': 0,
    ...
    'head_selection_file': 'ref_target_mapping/ref_target_heads_values.json', # NEW: File for saving/loading head selections
    ...
    'model_weights_file': 'model_pickles/all_model_weights_values.pkl', # NEW: Filename for single weights file
